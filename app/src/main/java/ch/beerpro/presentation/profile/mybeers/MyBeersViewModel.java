...
import ch.beerpro.data.repositories.PreisRepository;
...
public class MyBeersViewModel extends ViewModel implements CurrentUser {
    ...
    public MyBeersViewModel() {
        ...
        PreisRepository priceRepository = new PreisRepository();
        ...
        LiveData<List<Preis>> myPrices = priceRepository.getMyPrices(currentUserId);
